"""Bounded canonical JSON handling for Skill Manager contracts."""
...
MAX_JSON_COLLECTION_SIZE = 256
MAX_JSON_CHARACTERS = 1_000_000
MAX_JSON_INTEGER_BITS = 1_024
...
def validate_json(
    ...
    *,
    field_name: str,
    error_type: type[Exception] = SkillValidationError,
) -> None:
