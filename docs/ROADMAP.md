...
binding evidence. The final state means only eligible for future simulation
handoff review; Runtime remains unregistered and execution/physical validation
remain absent.
